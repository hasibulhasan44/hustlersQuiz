...
const EachSubject = ({EachSubject}) => {
    const {logo, name, total} = EachSubject;
    return (
        <div>
            <div>
                <div className='border-2 rounded-xl ml-4 bg-indigo-700 mb-8'>
                    ...
                    <div className=''>
                    <button className='border-2 border-double block mt-2 text-black text-xl mx-auto bg-indigo-300 flex items-center p-1 rounded-lg mb-4'>Jump to Quiz<ArrowRightIcon className='h-6 w-6 ml-2'></ArrowRightIcon></button>
                    </div>
